...
public class UserServiceImpl implements UserService {
    ...
    public void myMail() {
        ...
        // User AS u WHERE u.user_id=:id", User.class);
        // query.executeUpdate();
    ...
    public void updateUser( String fn, String mn, String ln, String email, String dept, String desg, String dob,
        ...
        // String pr_h, String pr_st, String pr_po, String pr_city, String
        // pr_dis, String pr_cntry,
        // String p_h, String p_st, String p_po, String p_city, String p_dis,
        // String p_cntry) {
        ...
        // TypedQuery<User> query = entityManager.createQuery("UPDATE User u SET
        // u.name = :name WHERE u.email='" + eml.getEmail() +"'", User.class);
        /*
         * Query query =
    ...
    public List<User> findAllUsers() {
        ...
        // return entityManager.createQuery(usersListQuery,
     ...
     * getSqlParameterByModel(user)); // System.out.println(sql); //User eml=
     * findUserByEmail(user.getEmail()); //System.out.println(eml);
     * 
     * //entityManager.merge(user);
     * 
     * //String
     * sql="update User set id="+user.getId()+", namae='"+user.getName()
    ...
    @Override
    public User createNewUser( User user ) throws ClientException {
        ...
        if ( userExists != null ) {
            throw new ClientException(
                    new ApiError(
                            ...
                            "Cannot create the user. It the is already an user with this ID",
                            List.of() ) );
        }
        if ( user.getMyRole() == "" ) {
            rl = "USER";
            ...
            HRRecord hrRecord = new HRRecord( user.getId(), 30, 0, 30, 5, 5, 5, 5, 5, 5, 0, 0, 0, 0, 0, 0, 5, 5, 5, 5,
                    5,
                    5 );
