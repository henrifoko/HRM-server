...
public class Attendance implements Serializable {
    ...
    * */
	...
	public com.frsummit.HRM.model.Attendance toLocalModel() {
		com.frsummit.HRM.model.Attendance attendance = new com.frsummit.HRM.model.Attendance();
		attendance.setAbsent(this.getAbsent());
		attendance.setAttendanceLink1(this.getAttendanceLink1());
		attendance.setAttendanceLink2(this.getAttendanceLink2());
		attendance.setAttendanceLink3(this.getAttendanceLink3());
		attendance.setAttendanceLink4(this.getAttendanceLink4());
		attendance.setAttendanceRemark(this.getAttendanceRemark());
		attendance.setAttendId(this.getAttendId());
		attendance.setInTime(this.getInTime());
		attendance.setLateBy(this.getLateBy());
		attendance.setOutTime(this.getOutTime());
		attendance.setOvertime(this.getOvertime());
		attendance.setPerformance(this.getPerformance());
		attendance.setShift(this.getShift());
		attendance.setSignTime(this.getSignTime());
		attendance.setStatus(this.getStatus());
		attendance.setUserId(this.getUserId());
		attendance.setWorkDuration(this.getWorkDuration());
		attendance.setWorkHourInDay(this.getWorkHourInDay());
