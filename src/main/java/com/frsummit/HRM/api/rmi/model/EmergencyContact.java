...
//    private Set<User> userEmergencyContact;
	...
	public com.frsummit.HRM.model.EmergencyContact toLocalModel() {
		com.frsummit.HRM.model.EmergencyContact ec = new com.frsummit.HRM.model.EmergencyContact();
		ec.setAddress(this.getAddress());
		ec.setName(this.getAddress());
		ec.setPhone(this.getPhone());
		ec.setUserId(this.getUserId());
