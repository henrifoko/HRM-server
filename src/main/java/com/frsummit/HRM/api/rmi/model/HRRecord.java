...
public class HRRecord implements Serializable {
	...
	public com.frsummit.HRM.model.HRRecord toLocalModel() {
		com.frsummit.HRM.model.HRRecord hrRecord = new com.frsummit.HRM.model.HRRecord();
		Set<User> originSet = this.getHrRecordUser();
		...
		hrRecord.setId(this.getId());
		hrRecord.setLeaveBalance(this.getLeaveBalance());
		hrRecord.setLeaveBalanceMaternity(this.getLeaveBalanceMaternity());
		hrRecord.setLeaveBalanceOther(this.getLeaveBalanceOther());
		hrRecord.setLeaveBalancePersonal(this.getLeaveBalancePersonal());
		hrRecord.setLeaveBalancePlanned(this.getLeaveBalancePlanned());
		hrRecord.setLeaveBalanceSick(this.leaveBalanceSick);
		hrRecord.setLeaveBalanceVacation(this.getLeaveBalanceVacation());
		hrRecord.setTotalLeave(this.getTotalLeave());
		hrRecord.setTotalLeaveMaternity(this.getTotalLeaveMaternity());
		hrRecord.setTotalLeaveOther(this.getTotalLeaveOther());
		hrRecord.setTotalLeavePersonal(this.getTotalLeavePersonal());
		hrRecord.setTotalLeavePlanned(this.getTotalLeavePlanned());
		hrRecord.setTotalLeaveSick(this.getTotalLeaveSick());
		hrRecord.setTotalLeaveTaken(this.getTotalLeaveTaken());
		hrRecord.setTotalLeaveTakenMaternity(this.getTotalLeaveTakenMaternity());
		hrRecord.setTotalLeaveTakenOther(this.getTotalLeaveTakenOther());
		hrRecord.setTotalLeaveTakenPersonal(this.getTotalLeaveTakenPersonal());
		hrRecord.setTotalLeaveTakenPlanned(this.getTotalLeaveTakenPlanned());
		hrRecord.setTotalLeaveTakenSick(this.getTotalLeaveTakenSick());
		hrRecord.setTotalLeaveTakenVacation(this.getTotalLeaveTakenVacation());
		hrRecord.setTotalLeaveVacation(this.getTotalLeaveVacation());
		hrRecord.setUserId(this.getUserId());
