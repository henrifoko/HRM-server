...
public class User implements Serializable {
	...
	public com.frsummit.HRM.model.User toLocalModel() {
		...
		user.setFatherName(this.getFatherName());
		user.setFirstName(this.getFirstName());
		user.setId(this.getId());
		user.setImageName(this.getImageName());
		user.setIncomeTexNo(this.getIncomeTexNo());
		user.setLastName(this.getLastName());
		user.setMiddleName(this.getMiddleName());
		user.setMotherName(this.getMotherName());
		user.setMyRole(this.getMyRole());
		user.setNationality(this.getNationality());
		user.setNid(this.getNid());
		user.setPassportNumber(this.getPassportNumber());
		user.setPassword(this.getPassword());

		com.frsummit.HRM.model.Address address = new com.frsummit.HRM.model.Address();
		com.frsummit.HRM.api.rmi.model.Address permanentAddress = this.getPermanentAddress();
		...
		com.frsummit.HRM.api.rmi.model.Address presentAddress = this.getPermanentAddress();
