...
//                       String p_h, String p_st, String p_po, String p_city, String p_dis, String p_cntry);
	...
	public void updateUserProperty(String userId, String prop, Object value); // NEW stl - exposed
	...
	// New services
	public User createNewUser(User user); // Créer un nouvel utilisateur - TO BE EXPOSED
